...
function renderFields(format) {
  ...
  if (format === "Fill in the Bleep!") {
    const prompts = [
      { id: "story", label: "Story or Genre", placeholder: "e.g., My worst first date" },
...
generateButton.addEventListener("click", async () => {
  ...
  if (currentFormat === "Taboops!") {
    ...
    const ids = [
      { id: "story", key: "storyTitle" },
      { id: "noun1", key: "noun1" },
      { id: "adj", key: "adjective" },
      { id: "place", key: "place" },
      { id: "noun2", key: "noun2" },
      { id: "verb", key: "verb" },
      { id: "random1", key: "random1" },
      { id: "random2", key: "random2" },
    ];
